        ...
        <div className="flex flex-col md:flex-row items-center gap-16 lg:gap-24">
          <div className="flex-1 space-y-8">
            <h2 className="text-3xl md:text-5xl font-bold tracking-tight leading-tight">
              Skip the Waiting Room <br /> with Smart Queuing
            </h2>
            <p className="text-blue-100 text-lg max-w-lg leading-relaxed">
              Track your queue status in real-time from your phone. Arrive exactly when it's your turn and minimize exposure and wait times.
            </p>
            <ul className="space-y-4 pt-2">
              {['Real-time status updates', 'SMS notifications before your turn', 'Easy rescheduling and cancellations'].map((item, idx) => (
