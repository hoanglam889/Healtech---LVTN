                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="flex items-center gap-2">
                          ...
                          {appt.status === 'DONE' && (
                            <span className="bg-emerald-50 text-emerald-600 text-[10px] px-2 py-0.5 rounded-lg font-bold border border-emerald-100 flex items-center gap-1 shrink-0">
                              <Icons.CheckCircle2 className="w-3 h-3" /> Đã khám
                            </span>
                          )}
                        </div>
