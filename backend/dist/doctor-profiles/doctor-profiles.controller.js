...
let DoctorProfilesController = class DoctorProfilesController {
    ...
    update(id, updateDoctorProfileDto) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [create_doctor_profile_dto_1.CreateDoctorProfileDto]),
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], DoctorProfilesController.prototype, "findOne", null);
__decorate([
    (0, common_1.Patch)(':id'),
    __param(0, (0, common_1.Param)('id')),
